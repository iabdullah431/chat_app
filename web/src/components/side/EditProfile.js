...
class EditProfile extends React.Component {
    ...
    onSubmit = e => {
        ...
        instance.post('/api/account', data)
            ...
            <div className={this.props.open ? 'side-profile open' : 'side-profile'}>
                ...
                <div className="d-flex flex-column" style={{overflow: 'auto'}}>
                    ...
                    <Form onSubmit={this.onSubmit}>
                        ...
                        <Avatar src={this.props.user.avatar} file={this.state.image} onClick={this.showFileUpload} />
                        </div>
                        ...
                        <div className="bg-white px-3 py-2">
                            ...
                            <Input value={this.state.about} name="about" onChange={this.onChange} autoComplete="off" />
                        </div>
